...
@interface SKFDownLoadVoiceTVC ()

@end

@implementation SKFDownLoadVoiceTVC
...
- (void)reloadCache {
    ...
    NSArray <SKFDownLoadVoiceModel *>*downLoadingMs = [SKFDownLoadListernDataTool getDownLoadedVoiceMs];
